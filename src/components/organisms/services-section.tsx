...
const services = [
  ...
  },
  {
    logo: <Service3 />,
    title: "Quote",
    description: "Je construis un devis qui réponde le mieux à vos attentes et vous le présente pendant un rendez-vous de 1h. Si vous acceptez le devis, nous commençons notre collaboration.",
